...
(function ($) {
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("wowza", "video", [".*"], null, {
                templateRegex: /(.*)/,
                template: '<iframe src="/cms/multimedia/videos/embed?url=$1" width="425" height="349" allowfullscreen="true" allowscriptaccess="always" scrolling="no" frameborder="0"></iframe>',
                nocache: 1
            }),
